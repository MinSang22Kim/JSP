...
<%@ page import="week5.com.dao.Book" %>
<jsp:useBean id="bookDAO" class="week5.com.dao.BookRepository" scope="session" />
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
            ...
            <div class="col-md-4">
                <div class="card mb-4 box-shadow">
                    <div class="card-body">
                        ...
                        <p class="card-text"><strong>출판사:</strong> <%= book.getPublisher() %> | <strong>가격:</strong> <%= book.getUnitPrice() %>₩</p>
